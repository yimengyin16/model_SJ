# Load the following plan information of SJ Federated
 # Schedule of amortization payments for existing UAALs 



## Inputs
#   - inputs/data_raw/Data_SJFC_planInfo_AV2020.xlsx"
...
fn_dataRaw   <- "Data_SJFC_planInfo_AV2020.xlsx" 
...
save(init_amort_raw,
		 init_unrecReturns.unadj,
		 file = paste0(dir_dataOut, "Data_SJFC_planInfo_AV2020.RData"))
