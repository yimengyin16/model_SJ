## Loading decrement tables and salary scales from AV2020 of SJ Federated


## Inputs
#   - inputs/data_raw/Data_SJFC_decrements_AV2020.xlsx"
...
fn_dataRaw   <- "Data_SJFC_Decrements_AV2020.xlsx" 
...
save(
  ...
  df_salScale_raw,
	...
	file = paste0(dir_dataOut, "Data_SJFC_decrements_AV2020_raw.RData")
)
