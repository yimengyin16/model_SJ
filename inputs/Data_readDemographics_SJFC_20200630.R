## Loading demographic data of San Jose Federated plan as of 06/30/2020 in AV2020


## Inputs
#   - inputs/data_raw/Data_SJFC_Demographics_20200630.xlsx"
...
fn_dataRaw   <- "Data_SJFC_Demographics_20200630.xlsx" 
...
save(
  ...
  agecuts_retirees,
	...
	file = paste0(dir_dataOut, "Data_SJFC_demographics_20200630_raw.RData")
)
