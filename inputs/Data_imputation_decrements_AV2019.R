...
## Inputs
#   - inputs/data_raw/Data_SJPF_decrements_AV2019_raw.RData"
...
fn_inputs   <- "Data_SJPF_decrements_AV2019_raw.RData" 
...
save(
  ...
  df_salScale_imputed,
	...
	file = paste0(dir_outputs, "Data_SJPF_decrements_AV2019_imputed.RData")
)
