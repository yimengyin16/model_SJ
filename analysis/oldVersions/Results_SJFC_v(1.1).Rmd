...
df_C2 <- 
  df_results %>% 
	...
	filter(sim %in% c(0, -2), year %in% c(2020, 2029), str_detect(sim_name, "agg"), !str_detect(sim_name, "highERC") ) %>% 
...
df_sumTbl_chg1 %>%  
 ...
 tab_footnote(
    footnote = "All existing amortization bases in 2020 are expected to be paid off by 2039; present values are calculated with a discount rate of 6.625%.",
...
df_cohort.labels <- 
	tribble(
	~cohort, ~labels,
	"fc_t1_1991_25_55", "Tier 1 retiree\ncurrent age 55",
	"fc_t1_1996_25_55", "Tier 1 active\ncurrent age 50",
	"fc_t1_2011_25_55", "Tier 1 active\ncurrent age 35",
	"fc_t2_2021_25_55", "Tier 2 active\ncurrent age 25"
	)
...
idx_cohort_fc.t1 <- c(
    paste(c("fc", "t1", "1991", "25", "55"), collapse = "_"),
    paste(c("fc", "t1", "1996", "25", "55"), collapse = "_"),
    paste(c("fc", "t1", "2011", "25", "55"), collapse = "_")
    )


idx_cohort_fc.t2 <- c(
    paste(c("fc", "t2", "2021", "25", "55"), collapse = "_")
    )
